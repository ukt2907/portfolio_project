...
export default function Card({brief, heading}:CardProps) {
  return (
    <>
        <div className="container     px-8 md:px-0 md:pl-8 rounded-lg 
             ...
             <div className="md:pt-4  md:w-[55%]">
              <div className={inter.className}>
                ...
                <div className={calistoga.className}>
                  <h1 className="md:text-4xl md:mt-3 sm:text-3xl text-white max-w-72 md:max-w-screen-md ">{heading}</h1>
                </div>
              ...
              <div className="flex flex-col items-start">
                ...
                <button className="w-full  md:px-6 mt-6  rounded-lg py-2 bg-white/100 text-zinc-900">
